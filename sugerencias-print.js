(function () {
    ...
    stylePrint.innerHTML = `
        ...
        /* Plato en una sola línea */
        .sugerencias-plato { display: flex !important; align-items: baseline !important; margin-bottom: 10px !important; }
        ...
        .sugerencias-footer { margin-top: 40px !important; border-top: 1px solid #e2e8f0 !important; padding-top: 20px !important; display: flex !important; justify-content: space-between !important; }
    `;
    ...
    function cargarCarta() {
        ...
        html += `<div class="sugerencias-footer"><div>⚠️ Alérgenos disponibles.</div></div>`;
