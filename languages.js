// Diccionario Oficial de los 25 Idiomas de Wine Sync
const IDIOMAS_CONFIG = {
    ...
    CA: "català", EU: "Euskara", GL: "Galego", VA: "Valencià" // NUEVO: Agregados los 4 idiomas
};
...
const categoriesList = [ 
    ...
    { id: '8', ES: 'Postres', EN: 'Desserts', DE: 'Desserts', FR: 'Desserts', IT: 'Dolci', RU: 'Десерты', NL: 'Desserts', PL: 'Desery', SV: 'Efterrätter', NO: 'Desesser', DA: 'Desesser', FI: 'Jälkiruoat', PT: 'Sobremesas', RO: 'Deserturi', HU: 'Desszertek', CS: 'Dezerty', EL: 'Επιδόρπια', TR: 'Tatlılar', AR: 'حلويات', ZH: '甜点', JA: 'デザート', CA: 'Postres', EU: 'Postreak', GL: 'Sobremesas', VA: 'Postres' }, 
    ...
    { id: '11', ES: 'Cervezas', EN: 'Beers', DE: 'Biere', FR: 'Bières', IT: 'Birre', RU: 'Пиво', NL: 'Bieren', PL: 'Piwa', SV: 'Öl', NO: 'Øl', DA: 'Øl', FI: 'Olutta', PT: 'Cervejas', RO: 'Beri', HU: 'Sörök', CS: 'Priva', EL: 'Μπύρες', TR: 'Biralar', AR: 'بيرة', ZH: '啤酒', JA: 'ビール', CA: 'Cerveses', EU: 'Garagardoak', GL: 'Cervexas', VA: 'Cerveses' }, 
...
const subCatsLang = {
    ...
    rioja: { ES: 'Rioja', EN: 'Rioja', DE: 'Rioja', FR: 'Rioja', IT: 'Rioja', RU: 'Риоха', NL: 'Rioja', PL: 'Rioja', SV: 'Rioja', NO: 'Rioja', DA: 'Rioja', FI: 'Rioja', PT: 'Rioja', RO: 'Rioja', HU: 'Rioja', CS: 'Rioja', EL: 'Ριόχα', TR: 'Rioja', AR: 'ريوχα', ZH: '里奥哈', JA: 'リオハ', CA: 'Rioja', EU: 'Rioja', GL: 'Rioja', VA: 'Rioja' },
...
// Enrutamiento de Estructura de IDs en la aplicación (Intacto)
const ESTRUCTURA = [
